...
{ 
	public class GeneratedApplication : Outracks.Simulator.Client.Application
	{
		public GeneratedApplication()
			: base(
				new [] 
				{new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.1.41.145"), 12124)},"/Users/jaeyounchae/Documents/fuse/DreamPlus_popup/DreamPlus-popup.unoproj",new string[] 
				{ })
		{
