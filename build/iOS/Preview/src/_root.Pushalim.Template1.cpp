...
// {
// static Template1() :78
static void Pushalim__Template1__cctor__fn(uType* __type)
{
    Pushalim__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Value"*/]);
    Pushalim__Template1::__selector1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[1/*"Monthtext"*/]);
}

static void Pushalim__Template1_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::Pushalim_typeof(), offsetof(Pushalim__Template1, __parent1), uFieldFlagsWeak,
        ::g::Pushalim_typeof(), offsetof(Pushalim__Template1, __parentInstance1), uFieldFlagsWeak,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Pushalim__Template1, Monthvalue_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Pushalim__Template1, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(Pushalim__Template1, __self_Value_inst1), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(Pushalim__Template1, temp_eb3), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Pushalim__Template1::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&Pushalim__Template1::__selector1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Pushalim__Template1__New2_fn, 0, true, type, 2, ::g::Pushalim_typeof(), ::g::Pushalim_typeof()));
}
...
::g::Uno::UX::Template_type* Pushalim__Template1_typeof()
{
    ...
    options.ObjectSize = sizeof(Pushalim__Template1);
    options.TypeSize = sizeof(::g::Uno::UX::Template_type);
    type = (::g::Uno::UX::Template_type*)uClassType::New("Pushalim.Template1", options);
    type->fp_build_ = Pushalim__Template1_build;
    type->fp_cctor_ = Pushalim__Template1__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Template*, uObject**))Pushalim__Template1__New1_fn;
    return type;
}

// public Template1(Pushalim parent, Pushalim parentInstance) :69
...
{
    uStackFrame __("Pushalim.Template1", "New()");
    ::g::Fuse::Controls::Text* __self1 = ::g::Fuse::Controls::Text::New3();
    __this->Monthvalue_Value_inst = ::g::DreamPluspopup_FuseControlsTextControl_Value_Property::New1(uPtr(__this->__parent1)->Monthvalue, Pushalim__Template1::__selector0_);
    ...
    __this->temp_Value_inst = ::g::DreamPluspopup_FuseTriggersActionsSetstring_Value_Property::New1(temp, Pushalim__Template1::__selector0_);
    ::g::Fuse::Reactive::Data* temp1 = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"Monthselect"*/]);
    __this->__self_Value_inst1 = ::g::DreamPluspopup_FuseControlsTextControl_Value_Property::New1(__self1, Pushalim__Template1::__selector0_);
    ...
    __this->temp_eb3 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp3);
    __self1->FontSize(25.0f);
    __self1->TextAlignment(1);
    __self1->Color(::g::Fuse::Drawing::Colors::Purple());
    __self1->Alignment(0);
    __self1->Name(Pushalim__Template1::__selector1_);
    __self1->SourceLineNumber(49);
    __self1->SourceFileName(::STRINGS[4/*"Page/Pushal...*/]);
    ::g::Fuse::Gestures::Clicked::AddHandler(__self1, uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(__this->temp_eb3)));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), __this->temp_eb3);
    return *__retval = __self1, void();
}

// public Template1 New(Pushalim parent, Pushalim parentInstance) :69
void Pushalim__Template1__New2_fn(::g::Pushalim* parent, ::g::Pushalim* parentInstance, Pushalim__Template1** __retval)
{
    *__retval = Pushalim__Template1::New2(parent, parentInstance);
}

::g::Uno::UX::Selector Pushalim__Template1::__selector0_;
::g::Uno::UX::Selector Pushalim__Template1::__selector1_;

// public Template1(Pushalim parent, Pushalim parentInstance) [instance] :69
void Pushalim__Template1::ctor_1(::g::Pushalim* parent, ::g::Pushalim* parentInstance)
{
    ctor_(NULL, false);
    __parent1 = parent;
...
// public Template1 New(Pushalim parent, Pushalim parentInstance) [static] :69
Pushalim__Template1* Pushalim__Template1::New2(::g::Pushalim* parent, ::g::Pushalim* parentInstance)
{
    Pushalim__Template1* obj1 = (Pushalim__Template1*)uNew(Pushalim__Template1_typeof());
