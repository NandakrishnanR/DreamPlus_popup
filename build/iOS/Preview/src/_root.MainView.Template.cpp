...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"push"*/]);
}

static void MainView__Template_build(uType* type)
{
    ::STRINGS[0] = uString::Const("push");
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    ::g::push* __self1 = ::g::push::New5(uPtr(__this->__parent1)->router);
