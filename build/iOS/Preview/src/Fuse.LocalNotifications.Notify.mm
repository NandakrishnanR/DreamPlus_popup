...
static void Notify_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(6,
        ...
        new uFunction("add_Received", NULL, (void*)Notify__add_Received_fn, 0, true, uVoid_typeof(), 1, ::TYPES[1/*Uno.EventHandler<string>*/]),
        new uFunction("remove_Received", NULL, (void*)Notify__remove_Received_fn, 0, true, uVoid_typeof(), 1, ::TYPES[1/*Uno.EventHandler<string>*/]));
}
