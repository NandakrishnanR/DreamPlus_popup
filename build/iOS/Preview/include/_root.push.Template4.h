...
namespace g{struct push__Template4;}
...
struct push__Template4 : ::g::Uno::UX::Template
{
    ...
    static ::g::Uno::UX::Selector& __selector0() { return push__Template4_typeof()->Init(), __selector0_; }

    void ctor_1(::g::push* parent, ::g::push* parentInstance);
    static push__Template4* New2(::g::push* parent, ::g::push* parentInstance);
};
// }
