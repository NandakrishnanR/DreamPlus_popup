...
{
    DrawObjectWatcher::ShadingName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[33/*"Shading"*/]);
}
...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[15] = uObject_typeof()->Array();
    ::TYPES[16] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    type->SetDependencies(
...
{
    ::g::Fuse::Drawing::Brush__OnPinned_fn(__this);
    uPtr(__this->_stops)->RootSubscribe(uDelegate::New(::TYPES[12/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnAdded_fn, __this), uDelegate::New(::TYPES[12/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnRemoved_fn, __this));
}
...
{
    uArray* ind4;
    ind4 = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[16/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.GradientStop>*/], (uObject*)_stops);
...
void LinearGradient::ValidateStopsSorted(uObject* stops)
{
    ...
    for (int32_t i = 1; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(stops), ::TYPES[13/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/])); ++i)
        if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[14/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int32_t>(i), &ret7), ret7))->Offset() < uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[14/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int32_t>(i - 1), &ret8), ret8))->Offset())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::Format(::STRINGS[29/*"Gradient st...*/], uArray::Init<uObject*>(::TYPES[15/*object[]*/], 2, uBox(::g::Uno::Float_typeof(), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[14/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int32_t>(i - 1), &ret9), ret9))->Offset()), uBox(::g::Uno::Float_typeof(), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[14/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int32_t>(i), &ret10), ret10))->Offset())))));
}
// }
...
{
    ::TYPES[17] = ::g::Uno::Float4_typeof()->Array();
    ::TYPES[18] = ::g::Uno::Float_typeof()->Array();
    ...
    type->SetFields(0,
        ...
        ::TYPES[19/*float2[]*/], offsetof(LinearGradientDrawable, FillBuffer_Vertices_ae3a1d65_1_0_9), 0,
...
{
    uArray* Vertices_ae3a1d65_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[19/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
...
uArray* LinearGradientDrawable::FillBuffer_Colors_ae3a1d65_1_6_6(int32_t Colors_1_6_4, uArray* Colors_1_6_5)
{
    ...
    uArray* cols = uArray::New(::TYPES[17/*float4[]*/], ::g::Uno::Math::Max8(Colors_1_6_4, 1));
...
{
    LinearGradientDrawable_typeof()->Init();
    uArray* ofs = uArray::New(::TYPES[18/*float[]*/], ::g::Uno::Math::Max8(Offsets_1_5_1, 1));
...
{
    ::STRINGS[30] = uString::Const("Unsupport type for length: ");
    ::STRINGS[31] = uString::Const("Unsupported type for splitting: ");
    ::TYPES[19] = ::g::Uno::Float2_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Math_typeof());
    type->SetFields(0,
...
float LineSegment::EstimateLength(::g::Uno::Float2 from)
{
    switch (Type)
    {
        ...
        case 4:
            return 0.0f;
        case 3:
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[30/*"Unsupport t...*/], uBox<int32_t>(::g::Fuse::Drawing::LineSegmentType_typeof(), Type))));
    }
...
void LineSegment::SplitAtTime(::g::Uno::Float2 from, float t, LineSegment* left, LineSegment* right)
{
    ...
    switch (Type)
    {
        case 2:
        {
            uArray* p4 = uArray::Init< ::g::Uno::Float2>(::TYPES[19/*float2[]*/], 4, from, A, B, To);
        ...
        case 3:
        default:
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[31/*"Unsupported...*/], uBox<int32_t>(::g::Fuse::Drawing::LineSegmentType_typeof(), Type))));
    }
}
...
{
    uArray* next = uArray::New(::TYPES[19/*float2[]*/], uPtr(pts)->Length() - 1);
...
{
    ::STRINGS[32] = uString::Const("NativeSurface.Begin was not called");
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Drawing::CoreGraphicsSurface_type, interface0));
    type->SetFields(7,
...
void NativeSurface__VerifyBegun_fn(NativeSurface* __this)
{
    if (::g::Uno::IntPtr::op_Equality(__this->_cgContext, ::g::Uno::IntPtr::Zero_))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[32/*"NativeSurfa...*/]));
}
...
static void RepeatBaker_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[19/*float2[]*/], offsetof(RepeatBaker, FillBuffer_Vertices_2972f423_1_0_6), 0,
...
{
    uArray* Vertices_2972f423_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[19/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
...
{
    Stroke::_shadingName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[33/*"Shading"*/]);
    Stroke::_brushName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[34/*"Brush"*/]);
    Stroke::_colorName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[21/*"Color"*/]);
    Stroke::_widthName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[35/*"Width"*/]);
    Stroke::_offsetName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[20/*"Offset"*/]);
    Stroke::_adjustmentName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[36/*"Adjustment"*/]);
    Stroke::_alignmentName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[37/*"Alignment"*/]);
    Stroke::_lineCapName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[38/*"LineCap"*/]);
    Stroke::_lineJoinName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[39/*"LineJoin"*/]);
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[40/*"LineJoinMit...*/]);
}
...
static void Stroke_build(uType* type)
{
    ...
    ::STRINGS[40] = uString::Const("LineJoinMiterLimit");
...
void Stroke::Brush(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (IsPinned() && uIs((::g::Fuse::Drawing::Brush*)_brush, ::TYPES[20/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(_brush, ::TYPES[20/*Fuse.Drawing.DynamicBrush*/]))->RemovePropertyListener((uObject*)this);

    _brush = value;

    if (IsPinned() && uIs((::g::Fuse::Drawing::Brush*)_brush, ::TYPES[20/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(_brush, ::TYPES[20/*Fuse.Drawing.DynamicBrush*/]))->AddPropertyListener((uObject*)this);
...
void Stroke::SetColor(::g::Uno::Float4 color, uObject* origin)
{
    ...
    {
        if (!uIs((::g::Fuse::Drawing::Brush*)Brush(), ::TYPES[21/*Fuse.Drawing.SolidColor*/]))
            Brush(::g::Fuse::Drawing::SolidColor::New3(color));
        else
            uPtr(uCast< ::g::Fuse::Drawing::SolidColor*>(Brush(), ::TYPES[21/*Fuse.Drawing.SolidColor*/]))->Color(color);
...
{
    ::STRINGS[41] = uString::Const("GLDraw called with mismatched elements");
    ::STRINGS[42] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Surface.uno");
    ::STRINGS[43] = uString::Const("Draw");
    ::TYPES[22] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[23] = ::g::Fuse::Drawing::ISurfaceDrawable_typeof();
    type->SetDependencies(
        ::g::Fuse::Common::Blitter_typeof(),
        ::g::Uno::Math_typeof());
    type->SetInterfaces(
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[41/*"GLDraw call...*/], this, ::STRINGS[42/*"/usr/local/...*/], 119, ::STRINGS[43/*"Draw"*/]);

    float pixelsPerPoint = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(elm)->Viewport()), ::TYPES[22/*Fuse.ICommonViewport*/]));
...
{
    SetElementSize(::g::Fuse::Drawing::ISurfaceDrawable::ElementSize(uInterface(uPtr(drawable), ::TYPES[23/*Fuse.Drawing.ISurfaceDrawable*/])));
    ::g::Fuse::Drawing::ISurfaceDrawable::Draw(uInterface(drawable, ::TYPES[23/*Fuse.Drawing.ISurfaceDrawable*/]), this);
}
...
{
    SurfaceManager::_owners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[24/*Uno.Collections.Dictionary<object, Fuse.Drawing.Surface>*/]));
}

static void SurfaceManager_build(uType* type)
{
    ::TYPES[24] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Drawing::Surface_typeof(), NULL);
    ::TYPES[25] = ::g::Fuse::Visual_typeof();
    ::TYPES[26] = ::g::Fuse::Drawing::INativeSurfaceOwner_typeof();
    ::TYPES[27] = ::g::Fuse::Drawing::ISurfaceProvider_typeof();
    ::TYPES[23] = ::g::Fuse::Drawing::ISurfaceDrawable_typeof();
    type->SetFields(0,
        ::TYPES[24/*Uno.Collections.Dictionary<object, Fuse.Drawing.Surface>*/], (uintptr_t)&SurfaceManager::_owners_, uFieldFlagsStatic);
}
...
::g::Fuse::Drawing::Surface* SurfaceManager::Create(uObject* owner)
{
    ...
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(owner, ::TYPES[25/*Fuse.Visual*/]);

    if ((v != NULL) && (uPtr(v)->VisualContext() == 2))
    {
        uObject* nativeOwner = uAs<uObject*>(uPtr(v)->ViewHandle(), ::TYPES[26/*Fuse.Drawing.INativeSurfaceOwner*/]);

        if (nativeOwner != NULL)
            c = ::g::Fuse::Drawing::INativeSurfaceOwner::GetSurface(uInterface(uPtr(nativeOwner), ::TYPES[26/*Fuse.Drawing.INativeSurfaceOwner*/]));
    }
...
::g::Fuse::Drawing::Surface* SurfaceManager::FindImpl(::g::Fuse::Node* source, bool create)
{
    ...
    while (from != NULL)
    {
        if (uIs(from, ::TYPES[27/*Fuse.Drawing.ISurfaceProvider*/]) && (from != source))
            provider = uAs<uObject*>(from, ::TYPES[27/*Fuse.Drawing.ISurfaceProvider*/]);

        if (uIs(from, ::TYPES[23/*Fuse.Drawing.ISurfaceDrawable*/]))
