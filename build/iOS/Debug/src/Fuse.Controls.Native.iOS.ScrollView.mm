// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.9.0/iOS/ScrollView.uno.
...
{
    ::g::Uno::Float2 contentSize = ::g::Fuse::Controls::Native::IScrollViewHost::ContentSize(uInterface(uPtr(__this->_host), ::TYPES[1/*Fuse.Controls.Native.IScrollViewHost*/]));
