...
{
    ::TYPES[7] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[8/*int*/], offsetof(FontFaceDescriptor, Index), 0,
        ::TYPES[9/*Uno.Collections.IEnumerable<string>*/], offsetof(FontFaceDescriptor, Styles), 0);
}
...
void FontFaceDescriptor__GetHashCode_fn(FontFaceDescriptor* __this, int32_t* __retval)
{
    ...
    uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Styles), ::TYPES[9/*Uno.Collections.IEnumerable<string>*/]));

    {
        ...
        {
            {
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum2), ::TYPES[12/*Uno.IDisposable*/]));
            }
                        throw __t;
...
static void ImageContainer_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[24/*Uno.EventHandler*/], offsetof(ImageContainer, ParamChanged1), 0,
        ::TYPES[24/*Uno.EventHandler*/], offsetof(ImageContainer, SourceChanged1), 0,
        ::TYPES[25/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(ImageContainer, SourceError1), 0);
}
...
void ImageContainer::CreateMultiDensitySource()
{
...

    {
        ...
        {
            {
                while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[10/*Uno.Collections.IEnumerator*/])))
                {
        ...
        {
            {
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum4), ::TYPES[12/*Uno.IDisposable*/]));
            }
                        throw __t;
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    ::g::Fuse::Resources::MultiDensityImageSource* mf = uAs< ::g::Fuse::Resources::MultiDensityImageSource*>(src, ::TYPES[21/*Fuse.Resources.MultiDensityImageSource*/]);

    if (mf != NULL)
    {
        uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::TYPES[22/*Uno.Collections.IEnumerable<Fuse.Resources.ImageSource>*/]));
