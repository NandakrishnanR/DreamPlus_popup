...
::g::Fuse::Visual* FocusPrediction::NextSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    ...
    int32_t index = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), parent->Children(), child, &ret1), ret1);
...
::g::Fuse::Visual* FocusPrediction::PreviousSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    int32_t ret5;
    ::g::Fuse::Node* ret6;
    int32_t offset = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), uPtr(parent)->Children(), child, &ret5), ret5) - 1;
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.9.0/Input/Gesture.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[9/*"Missing Los...*/], uBox<int32_t>(::g::Uno::Int_typeof(), uPtr(args)->PointIndex())), this, ::STRINGS[10/*"/usr/local/...*/], 281, ::STRINGS[11/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
