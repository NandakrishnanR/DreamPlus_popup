// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.9.0/iOS/FontCache.uno.
...
::g::ObjC::Object* FontCache::Get(::g::Fuse::Internal::FontFaceDescriptor* descriptor, float size)
{
    ...
    {
        path = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::IO::Directory::GetUserDirectory(2), ::STRINGS[0/*"/tempFont"*/]), uBox<int32_t>(::g::Uno::Int_typeof(), ::g::Uno::Object::GetHashCode(uPtr(uPtr(descriptor)->FileSource))));
