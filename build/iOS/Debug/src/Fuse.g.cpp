...
{
    Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(Diagnostics::UserTypeOf(obj), uString::Const(" cannot be used in a ")), Diagnostics::UserTypeOf(actualParent)), ::STRINGS[47/*"."*/]), uString::Const(" A ")), expectedType), uString::Const(" parent is expected")), obj, filePath, lineNumber, memberName, NULL);
}
...
{
    ::STRINGS[34] = uString::Const("descriptors");
    ::STRINGS[35] = uString::Const("font contains no descriptors!");
    type->SetFields(0,
...
{
    if (descriptors == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[34/*"descriptors"*/]));

    if (uPtr(descriptors)->Count() < 1)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[35/*"font contai...*/]));
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int32_t width, int32_t height, int32_t format, int32_t flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[36/*"Attempted t...*/], uBox<int32_t>(::g::Uno::Int_typeof(), width)), ::STRINGS[37/*"x"*/]), uBox<int32_t>(::g::Uno::Int_typeof(), height)), ::STRINGS[38/*" framebuffe...*/]), uBox<int32_t>(::g::Uno::Int_typeof(), maxSize)), ::STRINGS[37/*"x"*/]), uBox<int32_t>(::g::Uno::Int_typeof(), maxSize))));
...
{
    ILoadingStatic::IsLoadingName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[41/*"IsLoading"*/]);
}
...
uObject* Json::Convert(::g::Uno::Data::Json::JsonReader* r)
{
    switch (uPtr(r)->JsonDataType())
    {
        case 5:
        {
            ...
            ::g::Uno::Collections::Dictionary* dict = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[72/*Uno.Collections.Dictionary<string, object>*/]);
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[28/*Fuse.IObject*/]))
    {
        ...
        uArray* keys = uArray::New(::TYPES[43/*string[]*/], uPtr(::g::Fuse::IObject::Keys(uInterface(uPtr(obj), ::TYPES[28/*Fuse.IObject*/])))->Length());
...
static void Marshal__cctor__fn(uType* __type)
{
    ...
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List`1*/]->MakeType(Marshal__IConverter_typeof(), NULL)));
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[42/*"Cannot conv...*/], o), uString::Const("' to target type '")), t), ::STRINGS[44/*"'"*/]), diagnosticSource, uString::Const("/usr/local/share/uno/Packages/Fuse.Marshal/1.9.0/Marshal.Convert.uno"), 103, uString::Const("TryConvertTo"), NULL);
...
{
    ::STRINGS[42] = uString::Const("Cannot convert '");
    ::STRINGS[43] = uString::Const("' to required target type '");
...
{
    ctor_1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[42/*"Cannot conv...*/], v), ::STRINGS[43/*"' to requir...*/]), t), ::STRINGS[44/*"'"*/]));
}
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyDown(uDelegate::New(::TYPES[36/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyUp(uDelegate::New(::TYPES[36/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
}
...
static void NameRegistry_build(uType* type)
{
    ...
    ::TYPES[42] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[37/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/], (uintptr_t)&NameRegistry::_nameToObj_, uFieldFlagsStatic,
        ::TYPES[38/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/], (uintptr_t)&NameRegistry::_names_, uFieldFlagsStatic,
        ::TYPES[39/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/], (uintptr_t)&NameRegistry::_listeners_, uFieldFlagsStatic);
}
...
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners_), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners_), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[40/*Uno.Collections.List<Fuse.INameListener>*/]));
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj_), uCRef(name), &ret26), ret26))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj_), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[42/*Uno.Collections.List<Fuse.Node>*/]));
...
static void NameValuePair_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const(": ");
    ::STRINGS[16] = uString::Const(")");
    ::STRINGS[46] = uString::Const("Object (NameValuePair) does not contain the given key");
    ::TYPES[43] = ::g::Uno::String_typeof()->Array();
    type->SetInterfaces(
...
void NameValuePair__FuseIObjectget_Item_fn(NameValuePair* __this, uString* key, uObject** __retval)
{
    if (::g::Uno::String::op_Inequality(key, __this->Name()))
        U_THROW(::g::Uno::ArgumentException::New4(::STRINGS[46/*"Object (Nam...*/]));
...
{
    return *__retval = uArray::Init<uString*>(::TYPES[43/*string[]*/], 1, (uString*)__this->Name()), void();
}
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[45/*"("*/], __this->Name()), ::STRINGS[11/*": "*/]), __this->Value()), ::STRINGS[16/*")"*/]), void();
}
...
void Node::AddDataListener(int32_t type, uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List`1*/]->MakeType(::TYPES[5/*Fuse.Node.IDataListener*/], NULL));
...
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[79/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Binding_typeof(), NULL));
}
...
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Binding_typeof(), NULL));
...
void NodeGroupBase::AddContent()
{
    ...
    _addedNodes = uArray::New(::TYPES[57/*Fuse.Node[]*/], addedNodesCount);
...
{
    ::TYPES[44] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[44/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_dict)->Keys()));
}
...
{
    return *__retval = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition(uBox<int32_t>(::g::Uno::Int_typeof(), __this->Major), ::STRINGS[47/*"."*/]), uBox<int32_t>(::g::Uno::Int_typeof(), __this->Minor)), ::STRINGS[47/*"."*/]), uBox<int32_t>(::g::Uno::Int_typeof(), __this->Patch)), void();
}
...
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[48/*"Parameter"*/]);
}
...
{
    ::TYPES[45] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[46] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[47] = ::g::Fuse::PlacedHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::TranslationModes_typeof());
    type->SetInterfaces(
...
{
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[46/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[45/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[45/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[47/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[46/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
...
{
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[45/*Fuse.IActualPlacement*/])), ::TYPES[45/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[47/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[46/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
...
static void PlacedArgs_build(uType* type)
{
    ...
    ::STRINGS[50] = uString::Const("width");
    ::STRINGS[51] = uString::Const("height");
    ::TYPES[48] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    type->SetInterfaces(
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[37/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[49/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[50/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[51/*"height"*/], (double)NewSize().Y);
}
...
{
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::IPreviewStateSaver_typeof(), NULL);
    ::TYPES[50] = ::g::Fuse::RootViewport_typeof();
    type->SetFields(0,
        ::g::Fuse::PreviewStateData_typeof(), offsetof(PreviewState, _current), 0,
        ::TYPES[49/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/], offsetof(PreviewState, _savers), 0);
}
...
{
    _savers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/]));
}
...
PreviewState* PreviewState::Find(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        ::g::Fuse::RootViewport* rv = uAs< ::g::Fuse::RootViewport*>(n, ::TYPES[50/*Fuse.RootViewport*/]);
...
{
    ::TYPES[1] = ::g::Uno::Action_typeof();
    ::TYPES[51] = ::g::Fuse::ITransformMode_typeof();
    type->SetInterfaces(
...
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[51/*Fuse.ITransformMode*/])), ::TYPES[51/*Fuse.ITransformMode*/]), (uObject*)this);
...
void RelativeTransform::ClearSubscription()
{
    ...
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[51/*Fuse.ITransformMode*/])), ::TYPES[51/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}
...
{
    ::TYPES[52] = ::g::Fuse::IFrame_typeof();
    ::TYPES[19] = ::g::Uno::EventHandler_typeof();
    ::TYPES[53] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[54] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Action_typeof();
    ::TYPES[55] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[56] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::Platform::Displays_typeof(),
        ::g::Fuse::UpdateManager_typeof());
    type->SetInterfaces(
        ...
        ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(RootViewport_type, interface11),
    ...
    type->SetFields(68,
        ::TYPES[52/*Fuse.IFrame*/], offsetof(RootViewport, _frame), 0,
        ...
        ::TYPES[56/*Uno.Action<float2>*/], offsetof(RootViewport, Resized1), 0);
}
...
{
    for (::g::Fuse::Visual* v = (::g::Fuse::Visual*)__this->FirstChild(::TYPES[53/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (::g::Fuse::Visual*)uPtr(v)->NextSibling(::TYPES[54/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
        uPtr(v)->Draw(dc);
}
...
{
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(__this->Children()), ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/]));
}
...
void RootViewport::ctor_4(uObject* frame)
{
    ...
    ctor_2();
    _frame = frame;
    ::g::Fuse::IFrame::add_FrameChanged(uInterface(uPtr(_frame), ::TYPES[52/*Fuse.IFrame*/]), uDelegate::New(::TYPES[19/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
...
void RootViewport::EstablishSizeInternals()
{
    ...
    _pixelSize = ::g::Fuse::IFrame::Size(uInterface(uPtr(_frame), ::TYPES[52/*Fuse.IFrame*/]));
...
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Resized1, value), ::TYPES[56/*Uno.Action<float2>*/]);
}

// public generated void remove_Resized(Uno.Action<float2> value) [instance] :37
void RootViewport::remove_Resized(uDelegate* value)
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Resized1, value), ::TYPES[56/*Uno.Action<float2>*/]);
}
...
{
    ::TYPES[57] = ::g::Fuse::Node_typeof()->Array();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[57/*Fuse.Node[]*/], offsetof(Visual__SafeIterator, _array), 0,
...
void Visual__SafeIterator::SecureCopy()
{
    if (_array == NULL)
    {
        ...
        {
            _array = uArray::New(::TYPES[57/*Fuse.Node[]*/], uPtr(_v)->_childCount - _pos);
            int32_t i = 0;
...
{
    ::TYPES[58] = ::g::Fuse::IScalingMode_typeof();
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[58/*Fuse.IScalingMode*/]), this);
}
...
{
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[46/*Fuse.ITransformRelative*/])), ::TYPES[45/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[45/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[47/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[46/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[46/*Fuse.ITransformRelative*/]));
}
...
{
    ::TYPES[59] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL)->Array();
    ::TYPES[61] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Fuse::UpdateStage_typeof(), offsetof(Stage, UpdateStage), 0,
        ::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Listeners), 0,
        ::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Onces), 0,
        ::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, OncesPending), 0,
        ::TYPES[60/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], offsetof(Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    UpdateStage = _updateStage;
    int32_t queueCount = 6;
    PhaseDeferredActions = uArray::New(::TYPES[60/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], queueCount);

    for (int32_t i = 0; i < queueCount; ++i)
        uPtr(PhaseDeferredActions)->Strong< ::g::Uno::Collections::Queue*>(i) = (::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[61/*Uno.Collections.Queue<Fuse.UpdateAction>*/]);
}
...
{
    ::TYPES[62] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[62/*Uno.Collections.List<Uno.UX.Template>*/], offsetof(TemplateSourceImpl, _templates), 0);
}
...
{
    if (_templates == NULL)
        _templates = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[62/*Uno.Collections.List<Uno.UX.Template>*/]));
...
{
    ::TYPES[63] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    type->SetInterfaces(
    ...
    type->SetFields(17,
        ::TYPES[63/*Uno.Action<Fuse.Transform>*/], offsetof(Transform, MatrixChanged1), 0);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[63/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[63/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    ::TYPES[64] = ::g::Fuse::ITranslationMode_typeof();
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[64/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[64/*Fuse.ITranslationMode*/]), __this);
...
::g::Uno::Float3 TranslationModes::SizeOf(::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[45/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[45/*Fuse.IActualPlacement*/]));
}
// }
...
{
    ::TYPES[65] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
        ::g::Uno::Action_typeof(), offsetof(UpdateAction, action), 0,
        ::TYPES[65/*Fuse.IUpdateListener*/], offsetof(UpdateAction, update), 0);
}
...
void UpdateAction::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[65/*Fuse.IUpdateListener*/]));
}
...
static void UpdateListener_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[65/*Fuse.IUpdateListener*/], offsetof(UpdateListener, update), 0,
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[66/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[67/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[67/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[52] = uString::Const("no Action found to remove");
    ::TYPES[66] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof(), NULL);
    ::TYPES[67] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[35] = ::g::Uno::Exception_typeof();
    ::TYPES[68] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[35/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ::TYPES[66/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&UpdateManager::_stages_, uFieldFlagsStatic,
        ::TYPES[67/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[67/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
...
void UpdateManager::ProcessDeferredActions(::g::Fuse::Stage* stage, ::g::Uno::Collections::List** _exceptions)
{
    ...
    for (::g::Fuse::UpdateAction* a = uPtr(stage)->GetFirstPriorityAction(); a != NULL; a = stage->GetFirstPriorityAction())
        ...
        catch (const uThrowable& __t)
        {
            ...
            if (*_exceptions == NULL)
                *_exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<Uno.Exception>*/]);
...
void UpdateManager::RemoveAction(uObject* pu, int32_t stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[52/*"no Action f...*/]));
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[69/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[70/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[53/*"raise"*/], uDelegate::New(::TYPES[71/*Uno.Action<Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn))));
}
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[55] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.9.0/UserEvent.uno");
    ...
    ::STRINGS[58] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.9.0/UserEvent.ScriptClass.uno");
    ...
    ::TYPES[22] = ::g::Uno::Type_typeof();
    ::TYPES[69] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[70] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[71] = ::g::Uno::Action2_typeof()->MakeType(type, uObject_typeof()->Array(), NULL);
    ::TYPES[28] = ::g::Fuse::IObject_typeof();
    ::TYPES[72] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[20] = ::g::Fuse::Visual_typeof();
    ::TYPES[73] = ::TYPES[20/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.UserEvent>*/, type, NULL);
    ::TYPES[74] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.UserEvent>*/, type, NULL);
    type->SetDependencies(
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"UserEvent r...*/], __this, ::STRINGS[55/*"/usr/local/...*/], 206, ::STRINGS[56/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[60/*"Trying to R...*/], this, ::STRINGS[55/*"/usr/local/...*/], 252, ::STRINGS[61/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Raise must ...*/], n, ::STRINGS[58/*"/usr/local/...*/], 76, ::STRINGS[53/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[58/*"/usr/local/...*/], 83, ::STRINGS[53/*"raise"*/], NULL);
        return;
    }

    uArray* keys = ::g::Fuse::IObject::Keys(uInterface(uPtr(so), ::TYPES[28/*Fuse.IObject*/]));
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[72/*Uno.Collections.Dictionary<string, object>*/]);
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            for (UserEvent* ue = (UserEvent*)uPtr(v)->FirstChild(::TYPES[73/*Fuse.Visual.FirstChild<Fuse.UserEvent>*/]); ue != NULL; ue = (UserEvent*)uPtr(ue)->NextSibling(::TYPES[74/*Fuse.Node.NextSibling<Fuse.UserEvent>*/]))
...
static void UserEventArgs_build(uType* type)
{
    ...
    ::TYPES[76] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[62/*"name"*/], ::g::Uno::UX::Selector__op_Implicit2(uPtr(__this->Dispatch())->Name()));
    ...
    if (__this->Args() != NULL)
    {
...

        {
            ...
            {
                {
                    while (enum1.MoveNext(::TYPES[75/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                    {
                        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > m = enum1.Current(::TYPES[75/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
                        ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[76/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[76/*Uno.Collections.KeyValuePair<string, object>*/]));
                    }
                }
            }
            ...
            {
                {
                    enum1.Dispose(::TYPES[75/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
                }
                                throw __t;
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[77/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/]));
}

static void UserEventDispatch_build(uType* type)
{
    ::TYPES[77] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), type, NULL);
    ::TYPES[1] = ::g::Uno::Action_typeof();
    ::TYPES[78] = ::g::Fuse::UserEventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::UpdateManager_typeof());
    type->SetFields(0,
        ::g::Uno::UX::Selector_typeof(), offsetof(UserEventDispatch, _Name), 0,
        ::TYPES[78/*Fuse.UserEventHandler*/], offsetof(UserEventDispatch, Raised1), 0,
        ::TYPES[77/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/], (uintptr_t)&UserEventDispatch::_userEvents_, uFieldFlagsStatic);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[78/*Fuse.UserEventHandler*/]);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[78/*Fuse.UserEventHandler*/]);
}
...
void Visual__OnArrangeMarginBox_fn(Visual* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    for (Visual* v = (Visual*)__this->FirstChild(::TYPES[53/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[54/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
    {
...
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Scripting::Function_typeof(), NULL)));
...
void Visual::AssignNaturalZOrder()
{
    ...
    for (Visual* v = (Visual*)FirstChild(::TYPES[53/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[54/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret9);
...
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    if (!IsRootingCompleted())
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret10);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret11), ret11))
        return;
...
void Visual::CancelInteractions(int32_t how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    ...
    if (how == 1)
        ...
        for (Visual* v = (Visual*)FirstChild(::TYPES[53/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)NextSibling(::TYPES[54/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
uArray* Visual::Children_GetCachedArray()
{
    ...
    uArray* nodes = uArray::New(::TYPES[57/*Fuse.Node[]*/], _childCount);
...
uArray* Visual::ComputeZOrder()
{
    ...
    if (_visualChildCount == 1)
        return uArray::Init<Visual*>(Visual_typeof()->Array(), 1, (Visual*)FirstChild(::TYPES[53/*Fuse.Visual.FirstChild<Fuse.Visual>*/]));
...
void Visual::ConcludePendingRemove()
{
    ...
    if (HasBit(268435456))
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[55/*Uno.Collections.ICollection<Fuse.Node>*/]), this, &ret16);
        SetBit1(268435456, false);
    }
}
...
{
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[63/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[63/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
static void VisualEvent_build(uType* type)
{
    ...
    ::STRINGS[64] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.9.0/Event.uno");
    ::TYPES[79] = ::g::Uno::Collections::List_typeof();
    ::TYPES[35] = ::g::Uno::Exception_typeof();
    ::TYPES[20] = ::g::Fuse::Visual_typeof();
    ::TYPES[80] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array(), NULL);
    ::TYPES[6] = uObject_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof(),
    ...
    type->SetFields(0,
        ...
        ::TYPES[79/*Uno.Collections.List`1*/]->MakeType(type->T(0), NULL), offsetof(VisualEvent, _globalHandlers), 0);
}
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int32_t type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[80/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[80/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[63/*"Invalid Rai...*/], 0, ::STRINGS[64/*"/usr/local/...*/], 105);
            return;
        }
    }
...
{
    ::STRINGS[65] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[65/*"visual"*/]));
...
{
    VisualListCache::_visualListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[81/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/]));
}

static void VisualListCache_build(uType* type)
{
    ::TYPES[81] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), NULL);
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[81/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/], (uintptr_t)&VisualListCache::_visualListCache_, uFieldFlagsStatic);
}
...
::g::Uno::Collections::List* VisualListCache::Acquire()
{
    ...
    return (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[82/*Uno.Collections.List<Fuse.Visual>*/]);
}
...
{
    ::STRINGS[66] = uString::Const("Wrapped Exception");
    type->SetFields(4);
}
...
{
    ctor_2(::STRINGS[66/*"Wrapped Exc...*/], inner);
}
