...
public class AndroidImpl
{
        ...
        com.fuse.Activity.subscribeToIntents(
            new com.fuse.Activity.IntentListener() {
                public void onIntent (Intent newIntent) {
                    ...
                    String payload = newIntent.getStringExtra(ExternedBlockHost.callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372());
                    String result = "{ 'title': '" + title + "', 'body': '" + body + "', 'payload': '" + payload + "' }";
                    ExternedBlockHost.callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved373((String)result);
                }
            },
            ExternedBlockHost.callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372());
    }
    
    public static void Later374(final String title,final String body,final boolean sound,final String strPayload,final int delaySeconds)
    {
        ...
        int id = ExternedBlockHost.callUno_Fuse_LocalNotifications_AndroidImpl_NextID375();
        
        intent.putExtra("id", id);
        intent.putExtra("title", title);
        intent.putExtra("body", body);
        intent.putExtra("sound", sound);
        intent.putExtra(ExternedBlockHost.callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372(), strPayload.toString());
    ...
    public static void OnNotificationRecieved(final Object _context,final Object _intent)
    {
        ...
        if (com.fuse.LocalNotifications.LocalNotificationReceiver.InForeground)
        {
            ...
            Intent notificationIntent = new Intent(context, com.apps.dreampluspopup.DreamPluspopup.class);
            ...
            Notification.Builder notificationBuilder = new Notification.Builder(context)
                .setSmallIcon(com.apps.dreampluspopup.R.mipmap.notif)
