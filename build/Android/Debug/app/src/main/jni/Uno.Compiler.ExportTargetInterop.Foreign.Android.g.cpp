...
jint JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_NextID375(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
    JTRY
        int32_t __result=::g::Fuse::LocalNotifications::AndroidImpl::NextID();
...
jobject JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
void JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved373(JNIEnv *env,jclass clazz,jobject payload)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372", (char* const)"()Ljava/lang/String;", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet372},
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved373", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved373},
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_NextID375", (char* const)"()I", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_NextID375},
